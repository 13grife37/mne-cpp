...
\section{Introduction}
	...
	% brain death can hardly be called a disease :D pls insert any other disease detectable with MEG/EEG
	...
	% sentence felt a bit short the way it was. maybe change "quick" to a more professional word ;)

	The MNE-CPP  project builds tools for the purpose of making analyzing EEG and MEG data easier.
	Thus the whole project is open-source and everyone can contribute. As language only C++ is used, although the project 			simultaneously exists in other languages, e.g. Python. %TODO Nur Python?
