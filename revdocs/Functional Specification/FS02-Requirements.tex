...
\subsubsection{Integration in Disp3D}
	...
	\begin{aims}
		...
		\item[C141] A new function must be added to the Disp3D tree model. Internally this function must create a new 								handler.%Lorenz fragen, weil satz im Lastenheft nicht von dieser Welt.
	\end{aims}
	
\subsection{Non-Functional Requirements}
	
	%Klassen-/Methodennamen, Windows/Linux Unterstützung	
...
\subsection{Differentiating criteria}
	...
	\begin{aims}
		...
		\item[C412] The program does not %bereitet nur daten fuer die visualisierung auf, inhaltlich wird erstmal nichts 							interpreitert
