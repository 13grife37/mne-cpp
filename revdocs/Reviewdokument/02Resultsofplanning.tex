...
A large part of the first phase of the project (i.e. scheduling and draft) is reflected in
...
\begin{aims}
	...
	Every phase ends with a presentation by the responsible team members about the developments and progress during the sprint. The end of the respective phase of the project is marked by a working prototype and a presentation which includes a summary of the work done by the entire team. 
...
\subsubsection{Effort Estimate} \label{effortEstimate}
...
\subsubsection{Risk Estimate} \label{riskEstimate}
