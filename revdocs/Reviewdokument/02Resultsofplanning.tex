...
This section contains information about the chosen software model, based on the requirements of the project.
...
In this section, the probabilities of different risks that the project contains are listed. This will help the team to determine which aspects of the implementation should get a higher priority.
...
In case one of the mentioned problems occurs, certain strategies for solving the issue are provided. Only the ones having crucial impact on the project are dealt with in the following section. 
