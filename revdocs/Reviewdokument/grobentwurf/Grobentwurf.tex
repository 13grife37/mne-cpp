...
\lhead{\sc{Preliminary Design: RMU}}	
...
%\begin{figure}[h]
%	\begin{center}
%		\includegraphics[width=10cm]{figures/geometryinfo_classdiagram.pdf}
%		\caption{Figure 2 - Interface of GeometryInfo}
%	\end{center}
%\end{figure}
...
%\begin{figure}[h]
%	\begin{center}
%		\includegraphics[width=10cm]{figures/interpolation_classdiagram.pdf}
%		\caption{Figure 3 - Interface of Interpolation}
%	\end{center}
%\end{figure}
