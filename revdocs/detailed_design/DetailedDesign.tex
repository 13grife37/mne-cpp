...
The method \textbf{nearesNeighbor} receives three input arguments: An MNEBemSurface, and two iterators which point to elements of a vector of sensor positions.
